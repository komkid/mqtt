...
const char* myThing = "SONOFF-FAN-AIO";// AIO / TV
const char* myTopic = "Fan/AIO";// AIO / TV
//################################################
...
int state = 1;
int workingMode = 0; // 1 = Auto, 0 = Manual
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if(strTopic == "Fan/Mode"){ //1 Auto , 0 = Manual
    if(strPayload == "1"){
